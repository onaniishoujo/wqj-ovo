<template>
    <nav :class="{ 'bg-transparent border-b-0': isTop, 'bg-white shadow-md border-b': !isTop }" class="z-50 w-full h-[64px] border flex lg:fixed top-0 items-center ease-in-out">
