var RENDERER = {
    ...
    jdugeToStopResize : function(){
        var width = document.documentElement.clientWidth, // this.$window.width(),
            height = document.documentElement.clientHeight, // this.$window.height(),
    ...
    render : function(){
        ...
        this.context.fillStyle = 'hsl(0, 0%, 94%)';
        // this.context.fillStyle = '-webkit-linear-gradient(-45deg, #bd34fe 50%, #47caff 50%);'
